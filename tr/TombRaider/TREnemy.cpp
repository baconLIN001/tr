...
void TREnemy::attack(TRHero *obj, int dmg){
    ...
    {
    case 0:
        gbgm->playMusic("Resources/Bgm/boss攻击.wav",true);
        break;
    case 1:
        gbgm->playMusic("Resources/Bgm/guard攻击.wav",true);
        break;
    case 2:
        gbgm->playMusic("Resources/Bgm/mummy攻击.wav",true);
        break;
    case 3:
        gbgm->playMusic("Resources/Bgm/bat攻击.wav",true);
    }
    obj->beAttacked(dmg);
}
